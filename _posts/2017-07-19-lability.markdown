---
layout: post
title:  "Building Hyper-V lab environments using PowerShell DSC"
...
![alt](/images/Lability_DSC_Lab_03.png){:height="184px" width="500px"}
...
![alt](/images/Lability_DSC_Lab_05.png){:height="147px" width="600px"}
...
![alt](/images/Lability_DSC_Lab_06.png){:height="202px" width="600px"}
...
The above is just a small part of the complete help topic, you can read the complete file [here](https://github.com/VirtualEngine/Lability/blob/dev/en-US/about_Labililty.help.txt). An extract of the help file:
...
![alt](/images/Lability_DSC_Lab_08.png){:height="160px" width="600px"}
